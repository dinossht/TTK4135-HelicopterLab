...
measured_data = Data.parse_data('qp_state_data.mat');
measured_data = reshape(measured_data, [2, 2])';
input_data = Data.parse_data('qp_input_data.mat');
...
for i = 1:c_D
    ...
    sp = Subplotex([p(1,1), p(2,1)], 'QP calculated trajectory with $p_c$');
    sp.plot();
