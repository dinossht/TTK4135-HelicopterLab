 ...
 * C source code generated on : Tue Jan 29 14:16:04 2019
 *
...
void helicopter_output(void)
{
  ...
  if (helicopter_M->Timing.t[0] < helicopter_P.Step_Time) {
    rtb_Backgain = helicopter_P.Step_Y0;
  } else {
    rtb_Backgain = helicopter_P.Step_YFinal;
  }

  /* End of Step: '<Root>/Step' */

  /* Gain: '<Root>/Gain' */
  helicopter_B.Gain_ew = helicopter_P.Gain_Gain_nz * rtb_Backgain;
  ...
  if (rtmIsMajorTimeStep(helicopter_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[0] = helicopter_B.Gain_ew;
   ...
   *  Sum: '<S5>/Sum3'
   */
  helicopter_B.Sum1 = ((helicopter_B.Gain_ew - helicopter_B.Gain1[2]) *
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  rtmSetTFinal(helicopter_M, 10.0);
  helicopter_M->Timing.stepSize0 = 0.002;
  helicopter_M->Timing.stepSize1 = 0.002;

  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (2093561717U);
  helicopter_M->Sizes.checksums[1] = (1307526378U);
  helicopter_M->Sizes.checksums[2] = (520406035U);
  helicopter_M->Sizes.checksums[3] = (3719311552U);
