...
measured_data = Data.parse_data('measured_data_p4_optional_closed_loop.mat');
measured_data = reshape(measured_data, [2, 3])';
input_data = Data.parse_data('input_data_p4_optional_closed_loop.mat');
...
% Set up subplot grid and plot
    sp = Subplotex([p(1, 1), p(2, 1), p(3, 1)], 'Closed loop control with $e$ and additional constraints on $\dot{\lambda}$');
    sp.plot();
